...
export default function LandingForm({ locale, dict }: LandingFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="w-full flex flex-col items-center">
      <div className="w-full max-w-5xl mx-auto bg-white border border-[#dedede] rounded-[24px] p-4 sm:p-6 md:p-8 shadow-xs">
        {/* ================= PC / TABLET VIEW (md 이상: 768px+) ================= */}
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-[#faf9f7]/95 backdrop-blur-md border-t border-[#dedede] p-3 pb-[calc(0.75rem+env(safe-area-inset-bottom))] shadow-lg flex flex-col gap-2">

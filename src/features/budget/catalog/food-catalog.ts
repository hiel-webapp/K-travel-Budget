...
export const NATIONAL_K_FOODS: FoodItemDefinition[] = [
  ...
  },
  {
    id: "nat_bibimbap",
    scope: "NATIONAL",
    nameKo: "놋그릇 전주 전통 육회/비빔밥 정식",
    nameEn: "Authentic Jeonju Bibimbap Set x 2",
    descKo: "따뜻한 놋그릇에 사골 육수로 지은 밥과 제철 나물, 신선한 육회, 고추장, 참기름을 얹어 비벼 먹는 전통 전주 한옥 명품 정식",
    descEn: "Authentic Jeonju bibimbap served in heavy brassware bowls, prepared with beef broth rice, assorted vegetables, and fresh beef tartare",
    categoryTag: "MEAL",
    unitPriceKrw: 26000,
    priceMinKrw: 22000,
    priceMaxKrw: 32000,
  ...
  BUSAN: [
    {
      ...
      cityCode: "BUSAN",
      nameKo: "부산 본토 돼지국밥",
      nameEn: "Busan Pork Soup (Dwaeji-gukbap) x 2",

...
export const CITY_SPECIALTY_FOODS: Record<SupportedCity, FoodItemDefinition[]> = {
  ...
  SEOUL: [
    ...
    },
    {
      ...
      cityCode: "SEOUL",
      nameKo: "장충동 족발",
      nameEn: "Jangchung-dong Jokbal (Braised Pig's Trotters)'s Trotters)",
      descKo: "각종 한약재와 비법 육수에 오랜 시간 푹 삶아내 쫄깃하고 부드러운 장충동 족발 골목의 원조 보양 요리",
      descEn: "Tender sliced pig's trotters slowly braised with herbs and soy sauce until gelatinous, soft, and richly savory's trotters slowly braised with herbs and soy sauce until gelatinous, soft, and richly savory",
      categoryTag: "BBQ_FEAST",
      unitPriceKrw: 28000,
      priceMinKrw: 24000,
      priceMaxKrw: 36000,

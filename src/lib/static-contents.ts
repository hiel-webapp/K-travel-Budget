  ...
  ko: [
    ...
    },
    {
      ...
      details: [
        ...
        "핵심 이용 규칙 (동일 노선 편도 1회): 유효기간 내 동일 구간은 편도 1회(왕복 1회)만 이용할 수 있습니다. (예: 서울➔부산 1회 탑승 후 동일한 서울➔부산 재탑승 불가, 부산➔서울 복귀 편도는 1회 가능). 따라서 단일 도시 단순 왕복보다는 여러 도시를 거치는 순환형 여행에 적합합니다.",
  ...
  en: [
    ...
    },
    {
      ...
      details: [
        ...
        "One-Way Per Route Rule: You can only travel once per direction on the same route during the pass validity (e.g., you cannot take Seoul ➔ Busan twice, but you can take Busan ➔ Seoul once). Designed specifically for multi-city circular travel rather than daily point-to-point commuting.",

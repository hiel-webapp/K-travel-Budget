...
export function getBasketLabel(
  ...
  const mapping: Record<BudgetBasketId, { ko: string; en: string }> = {
    ...
    HOSTEL_GUESTHOUSE: { ko: "호스텔 & 게스트하우스", en: "Hostel & Guesthouse" },
    BUSINESS_HOTEL: { ko: "도심 비즈니스 호텔", en: "Urban Business Hotel" },
    HANOK_BOUTIQUE: { ko: "전통 한옥 & 부티크", en: "Traditional Hanok & Boutique" },
    LUXURY_SKYLINE: { ko: "럭셔리 5성급 호텔", en: "5-Star Luxury Hotel" },

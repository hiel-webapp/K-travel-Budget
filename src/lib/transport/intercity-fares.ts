 ...
 * (기준: 2026년 공식 운임 및 실제 여행객 이동 패턴 정제 데이터)
 */
export const INTERCITY_FARE_TABLE: Record<string, IntercityFareInfo[]> = {
  ...
  "SEOUL-BUSAN": [
    ...
    { mode: "EXPRESS_BUS", nameKo: "우등 고속버스 (서울경부)", nameEn: "Express Bus (Seoul Terminal)", oneWayPriceKrw: 36000, durationTextKo: "4시간 15분", durationTextEn: "4h 15m", badgeTextKo: "가성비", badgeTextEn: "Budget" },
  ...
  "SEOUL-GYEONGJU": [
    ...
    { mode: "EXPRESS_BUS", nameKo: "우등 고속버스 (서울경부)", nameEn: "Express Bus (Seoul Terminal)", oneWayPriceKrw: 32600, durationTextKo: "3시간 30분", durationTextEn: "3h 30m" },
  ],
  "SEOUL-GANGNEUNG": [
    ...
    { mode: "EXPRESS_BUS", nameKo: "우등 고속버스 (서울경부)", nameEn: "Express Bus (Seoul Terminal)", oneWayPriceKrw: 21500, durationTextKo: "2시간 40분", durationTextEn: "2h 40m" },
  ],
  "SEOUL-YEOSU": [
  ...
  "SEOUL-SUWON": [
    ...
    { mode: "EXPRESS_BUS", nameKo: "광역 광역버스 / 지하철 1호선", nameEn: "Subway Line 1 / Express Bus", oneWayPriceKrw: 3000, durationTextKo: "45분", durationTextEn: "45m", badgeTextKo: "T-Money", badgeTextEn: "T-Money" },
  ],
  "SEOUL-SOKCHO": [
    { mode: "EXPRESS_BUS", nameKo: "우등 고속버스 (서울경부/동서울)", nameEn: "Express Bus (Seoul/Dongseoul)", oneWayPriceKrw: 23000, durationTextKo: "2시간 20분", durationTextEn: "2h 20m", isDefault: true, badgeTextKo: "직통추천", badgeTextEn: "Direct Bus" },
  ...
  "BUSAN-JEONJU": [
    { mode: "EXPRESS_BUS", nameKo: "시외 우등 고속버스 (사상터미널)", nameEn: "Intercity Express Bus (Sasang)", oneWayPriceKrw: 26000, durationTextKo: "3시간 10분", durationTextEn: "3h 10m", isDefault: true, badgeTextKo: "직통추천", badgeTextEn: "Direct Bus" },
  ...
  // =========================================================================
  // 7. 인천공항(INCHEON GATEWAY) ↔ 전국 도시 직행/연계 노선
  // =========================================================================
  "INCHEON-SEOUL": [

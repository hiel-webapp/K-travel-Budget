...
export const NATIONAL_K_FOODS: FoodItemDefinition[] = [
  // --- [그룹 1:  방한 외국인 최선호 4대 시그니처] ---
  {
    ...
    scope: "NATIONAL",
    nameKo: "성수 감성 숯불 삼겹살",
    nameEn: "K-BBQ Pork Belly (Samgyeopsal) x 2",
  ...
  },
  {
    id: "nat_chimaek",
    scope: "NATIONAL",
    nameKo: "한강 K-치맥 & 한강라면 세트",
    nameEn: "Han River Chimaek & Instant Ramyeon Set",
    descKo: "바삭하게 튀겨낸 치킨과 시원한 맥주, 한강 즉석 라면을 함께 즐기는 국민 야식",
  ...
  },
  {
    id: "nat_bulgogi",
    scope: "NATIONAL",
    nameKo: "전통 서울식 소불고기 전골",
    nameEn: "Traditional Bulgogi Feast x 2",
    descKo: "얇게 저민 소고기를 달콤 짭조름한 특제 양념에 재워 채소, 당면과 함께 자작하게 끓여낸 전통 서울식 불고기 전골 요리",
  ...
  },
  {
    id: "nat_bibimbap",
    scope: "NATIONAL",
    nameKo: "놋그릇 전주 전통 육회비빔밥 & 떡갈비 정식 2인",
    nameEn: "Authentic Jeonju Bibimbap & Tteokgalbi Feast x 2",
    descKo: "따뜻한 놋그릇에 사골 육수로 지은 밥과 제철 나물, 신선한 육회, 수제 떡갈비를 곁들인 전통 전주 한옥 명품 2인 정식",
...
export const CITY_SPECIALTY_FOODS: Record<SupportedCity, FoodItemDefinition[]> = {
  ...
  SEOUL: [
    ...
    },
    {
      ...
      scope: "CITY_LOCAL",
      cityCode: "SEOUL",
      nameKo: "성수 베이커리 & 라떼 인덱스",
      nameEn: "Seongsu Trendy Latte & Pastry",
      descKo: "성수동 감성 베이커리 카페의 소금빵과 스페셜티 카페라떼 조합",
      descEn: "Seongsu signature specialty cafe latte paired with freshly baked salted butter roll",
      categoryTag: "STREET_SNACK",
      unitPriceKrw: 16000,
      priceMinKrw: 12000,
      priceMaxKrw: 20000,
    ...
    },
    {
      ...
      scope: "CITY_LOCAL",
      cityCode: "SEOUL",
      nameKo: "인사동 전통 찻집 오미자차 & 한과 세트",
      nameEn: "Insadong Traditional Tea & Snack Set",
      descKo: "인사동 쌈지길 고즈넉한 한옥 찻집에서 즐기는 시원한 오미자차와 전통 유과·약과 한과 세트",
    ...
    {
      id: "seoul_korean_toast",
      scope: "CITY_LOCAL",
      cityCode: "SEOUL",
      nameKo: "아침 도심 공원 산책용 K-길거리 토스트 & 아메리카노",
      nameEn: "K-Street Toast & Morning Coffee x 2",
      descKo: "달콤 고소한 버터 식빵에 아삭한 양배추와 계란 부침, 햄, 치즈를 얹은 K-길거리 토스트와 모닝 아메리카노 2잔 세트",
      descEn: "Crispy sweet-and-savory Korean street toast packed with egg cabbage omelet, ham, cheese and two morning Americano coffees",
      categoryTag: "STREET_SNACK",
      unitPriceKrw: 14000,
      priceMinKrw: 12000,
      priceMaxKrw: 16000,
    ...
    },
    {
      ...
      scope: "CITY_LOCAL",
      cityCode: "SEOUL",
      nameKo: "명동 스트리트 푸드 콤보 (길거리 토스트, 호떡, 탕후루)",
      nameEn: "Myeongdong Street Food Tasting Combo",
      descKo: "명동 명물 꿀 호떡, 계란 토스트, 딸기 탕후루와 잡채 어묵 바를 한자리에서 즐기는 대표 길거리 미식 투어 콤보",
    ...
    {
      id: "gwangjang_yukhoe_bindaetteok",
      scope: "CITY_LOCAL",
      cityCode: "SEOUL",
      nameKo: "100년 전통 광장시장 맷돌 빈대떡 & 신선 육회 탕탕이 세트",
      nameEn: "Gwangjang Market Bindaetteok & Beef Tartare (Yukhoe) Combo",
      descKo: "100년 전통 광장시장의 명물 노릇노릇 맷돌 녹두빈대떡과 신선한 한우 소고기 육회·낙지 탕탕이 야식 콤보 세트",
      descEn: "Crisp stone-ground mung bean bindaetteok pancake paired with fresh Korean beef tartare (yukhoe) in historic Gwangjang Market",
      categoryTag: "MEAL",
      unitPriceKrw: 32000,
      priceMinKrw: 28000,
      priceMaxKrw: 38000,
    ...
    {
      id: "myeongdong_kfood_snack",
      scope: "CITY_LOCAL",
      cityCode: "SEOUL",
      nameKo: "명동 길거리 음식 콤보 (계란빵, 떡볶이, 붕어빵)",
      nameEn: "Myeongdong Street Snack Tasting Platter",
      descKo: "명동 야시장의 따끈한 달걀 품은 계란빵, 매콤달콤 쌀떡볶이, 바삭한 팥·슈크림 붕어빵을 함께 맛보는 길거리 간식 콤보",
      descEn: "Classic warm egg bread, spicy-sweet rice tteokbokki, and crispy fish-shaped bungeoppang pastries on Myeongdong street",
      categoryTag: "STREET_SNACK",
      unitPriceKrw: 16000,
      priceMinKrw: 12000,
      priceMaxKrw: 20000,
  ...
  BUSAN: [
    {
      ...
      scope: "CITY_LOCAL",
      cityCode: "BUSAN",
      nameKo: "부산 본토 깊은 국물 돼지국밥 & 맛보기 수육 2인",
      nameEn: "Busan Pork Soup (Dwaeji-gukbap) & Boiled Pork Platter x 2",
      descKo: "돼지 사골을 뽀얗게 우려낸 진한 육수에 푸짐한 고기와 맛보기 수육 한 접시, 부추 겉절이를 곁들인 부산 대표 2인 국밥",
    ...
    },
    {
      ...
      scope: "CITY_LOCAL",
      cityCode: "BUSAN",
      nameKo: "자갈치 회센터 제철 활어회 & 얼큰 매운탕 정식 2인",
      nameEn: "Jagalchi Market Fresh Sashimi Platter & Spicy Fish Stew",
      descKo: "부산 자갈치 수산시장에서 갓 건져 올린 신선한 광어·우럭 모둠 활어회와 칼칼하고 시원한 생선 서더리 매운탕 2인 상차림",
    ...
    },
    {
      ...
      scope: "CITY_LOCAL",
      cityCode: "BUSAN",
      nameKo: "남포동 비프(BIFF)거리 씨앗호떡 & 부산 물떡 꼬치 세트",
      nameEn: "Busan BIFF Square Seed Hotteok & Fish Cake Combo",
      descKo: "해바라기씨와 견과류가 듬뿍 들어간 남포동 원조 바삭 씨앗호떡과 진한 어묵 국물에 푹 끓여낸 쫀득한 부산 명물 물떡 꼬치 세트",
    ...
    },
    {
      ...
      scope: "CITY_LOCAL",
      cityCode: "BUSAN",
      nameKo: "광안리 오션뷰 조개구이/해산물 플래터",
      nameEn: "Gwangalli Ocean View Seafood Platter",
      descKo: "광안대교 오션뷰 야경과 함께 즐기는 신선한 모둠 조개구이와 해산물 플래터",
    ...
    },
    {
      ...
      scope: "CITY_LOCAL",
      cityCode: "BUSAN",
      nameKo: "남포동 씨앗호떡 & 부산 물떡 어묵",
      nameEn: "Busan Seed Hotteok & Fish Cake Combo",
      descKo: "남포동 BIFF거리의 명물 고소한 씨앗호떡과 부산 어묵 골목의 따끈한 물떡 세트",
  ...
  JEJU: [
    {
      ...
      scope: "CITY_LOCAL",
      cityCode: "JEJU",
      nameKo: "제주 참숯 흑돼지 구이 & 멜젓 쌈세트 (2인)",
      nameEn: "Authentic Jeju Black Pork BBQ Feast x 2",
      descKo: "청정 제주 한라산 자락 토종 흑돼지 두툼한 근고기를 참숯에 구워 멜젓(멸치젓)과 함께 즐기는 2인 명품 쌈세트",
    ...
    },
    {
      ...
      scope: "CITY_LOCAL",
      cityCode: "JEJU",
      nameKo: "해변 통문어·전복 해물라면 & 딱새우 콤보",
      nameEn: "Jeju Coastal Seafood Ramyeon & Shrimp Combo",
      descKo: "살아있는 통문어 한 마리와 전복, 꽃게, 홍합을 통째로 넣고 칼칼하게 끓인 명품 해물라면과 달큰한 딱새우 회 콤보",
    ...
    {
      id: "jeju_hallabong_dessert",
      scope: "CITY_LOCAL",
      cityCode: "JEJU",
      nameKo: "애월/함덕 오션뷰 카페 제주 한라봉 에이드 & 당근 케이크",
      nameEn: "Jeju Hallabong Citrus Ade & Oceanview Pastry",
      descKo: "제주산 상큼한 한라봉 수제 청으로 만든 스파클링 에이드 2잔과 구좌읍 특산 당근으로 구워낸 촉촉한 크림치즈 당근 케이크",
      descEn: "Two sparkling handmade Hallabong citrus ades paired with moist Gujwa carrot cream cheese cake at coastal oceanview cafe",
      categoryTag: "DESSERT_CAFE",
      unitPriceKrw: 16000,
      priceMinKrw: 14000,
      priceMaxKrw: 20000,
  ...
  JEONJU: [
    {
      ...
      scope: "CITY_LOCAL",
      cityCode: "JEONJU",
      nameKo: "전주 한옥마을 수제 초코파이 & 콩나물국밥 아침",
      nameEn: "Jeonju Choco Pie & Morning Soup",
      descKo: "한옥마을 명물 달콤한 수제 초코파이 디저트와 뚝배기 전주 콩나물국밥 아침 식사 콤보",
      descEn: "Iconic Jeonju handmade artisan choco pie paired with hot savory bean sprout soup breakfast",
      categoryTag: "MEAL",
      unitPriceKrw: 15000,
      priceMinKrw: 12000,
      priceMaxKrw: 18000,
      isMustEatTop3: true,
      emoji: "🍲",
      imageUrl: "https://tong.visitkorea.or.kr/cms/resource/18/2840018_image2_1.jpg",
    },
    {
      id: "jeonju_gamaek_culture",
      scope: "CITY_LOCAL",
      cityCode: "JEONJU",
      nameKo: "전주 레트로 골목 가맥(가게맥주) 황태구이 & 특제 소스 야식 세트",
      nameEn: "Jeonju Retro Street Pub (Gamaek) Dried Pollack & Beer",
      descKo: "전주 동문거리 노포 가맥집의 바삭하게 연탄불에 구워낸 황태포와 마요네즈·청양고추 특제 간장 소스, 시원한 병맥주 야식 세트",
      descEn: "Crispy briquette-grilled dried pollack served with secret chili mayonnaise soy sauce and cold beer at Jeonju's historic corner stores",
      categoryTag: "STREET_SNACK",
      unitPriceKrw: 22000,
      priceMinKrw: 18000,
      priceMaxKrw: 26000,
  ...
  GANGNEUNG: [
    ...
    {
      id: "gangneung_sundubu",
      scope: "CITY_LOCAL",
      cityCode: "GANGNEUNG",
      nameKo: "초당마을 명품 초당 짬뽕순두부 정식",
      nameEn: "Chodang Soft Tofu (Sundubu) Feast x 2",
      descKo: "동해안 깨끗한 바닷물 간수로 빚어낸 몽글몽글 초당 순두부와 칼칼하고 불향 가득한 해물 짬뽕 순두부 2인 정식",
      descEn: "Artisanal Chodang seafood soft tofu stew feast for two simmered in fiery, smoky broth with fresh East Sea clams and squid",
      categoryTag: "MEAL",
      unitPriceKrw: 26000,
      priceMinKrw: 24000,
      priceMaxKrw: 30000,
    ...
    },
    {
      ...
      scope: "CITY_LOCAL",
      cityCode: "GANGNEUNG",
      nameKo: "안목해변 커피거리 시그니처 오션뷰 커피 & 옥수수 라떼 콤보",
      nameEn: "Anmok Oceanview Cafe & Gangneung Corn Latte",
      descKo: "탁 트인 안목해변 오션뷰를 바라보며 즐기는 강릉 명물 고소한 초당 옥수수 라떼와 스페셜티 핸드드립 커피 2잔 세트",
      descEn: "Signature Chodang sweet corn latte paired with specialty oceanview drip coffee right along the renowned Anmok beach coffee street",
      categoryTag: "DESSERT_CAFE",
      unitPriceKrw: 15000,
      priceMinKrw: 13000,
      priceMaxKrw: 18000,
    ...
    },
    {
      ...
      scope: "CITY_LOCAL",
      cityCode: "GANGNEUNG",
      nameKo: "주문진 수산시장 생선구이 & 조개칼국수 점심",
      nameEn: "Jumunjin Seafood Noodle & Grilled Fish",
      descKo: "주문진 활어 수산시장에서 갓 잡아 노릇하게 구워낸 모둠 생선구이와 시원한 동해안 바지락 조개 칼국수 2인 식사",
  ...
  GYEONGJU: [
    ...
    },
    {
      ...
      scope: "CITY_LOCAL",
      cityCode: "GYEONGJU",
      nameKo: "대릉원 로컬 떡갈비 쌈밥 정식",
      nameEn: "Gyeongju Tteokgalbi Ssambap Feast x 2",
      descKo: "신선한 쌈채소와 정갈한 찬, 육즙 가득한 떡갈비를 곁들여 먹는 경주 대릉원 대표 쌈밥 한상",
      descEn: "Abundant wellness table offering fresh organic leafy wraps, savory handcrafted beef patties, and traditional side dishes",
      categoryTag: "MEAL",
      unitPriceKrw: 34000,
      priceMinKrw: 30000,
      priceMaxKrw: 42000,
    ...
    },
    {
      ...
      scope: "CITY_LOCAL",
      cityCode: "GYEONGJU",
      nameKo: "황리단길 십원빵 & 황남빵 디저트 콤보",
      nameEn: "Hwangridan-gil 10-Won Bread Combo",
      descKo: "모짜렐라 치즈가 듬뿍 늘어나는 황리단길 십원빵과 80년 전통 팥앙금 가득 황남빵 디저트 세트",
      descEn: "Cheesy 10-won coin waffle bread paired with historic sweet red bean Hwangnam-ppang pastries",
      categoryTag: "DESSERT_CAFE",
      unitPriceKrw: 10000,
      priceMinKrw: 8000,
      priceMaxKrw: 12000,

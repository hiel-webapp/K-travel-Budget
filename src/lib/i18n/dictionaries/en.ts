...
export const en: Dictionary = {
  ...
  planner: {
    ...
    trendHeroTitle: "K-Trend Hub",
    trendHeroSubtitle: "Discover the latest cultural vibes and lifestyle trends currently popular among Korean locals.",
  ...
  trendSection: {
    publicTrendNotice: "Public K-Trend offers general local travel trends. Personalized trend suggestions tailored to your itinerary & saved place candidates are available in the One-Stop Report.",
    cityFilterLabel: "Filter by City",
    allCitiesOption: "All Cities Trends",
    officialChannelNotice: "※ Please check official brand channels for specific pop-up and event details.",
    personalizedTitle: "Paid One-Stop Report: Personalized K-Trend Insights",
    personalizedSubtitle: "Customized trend briefing based on your visited cities, trip duration, and saved candidate categories.",
    personalizedLockedNotice: "Personalized detailed trend guides tailored to your itinerary are exclusive to the One-Stop Report.",
    reasonLabel: "Match Reason:",
    emptyPersonalizedNotice: "Personalized trend suggestions for your trip are currently being prepared.",
  },
};

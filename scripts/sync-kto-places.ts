...
export const VERIFIED_SEOUL_LANDMARKS: CatalogItemPayload[] = [
  // 1. 경복궁 & 광화문
  {
    ...
    price_krw: 3000,
    image_url: '/assets/gyeongbokgung-main.jpg',
  ...
  // 2. N서울타워 전망대
  {
    ...
    desc_en: 'Iconic tower atop Namsan Mountain offering a 360-degree panoramic skyline view of downtown Seoul. || SUBWAY: 4호선 명동역 3번 출구 (케이블카 도보 10분) / 3·4호선 충무로역 2번 출구 남산순환버스 01번 || HOURS: 10:00 ~ 23:00 (주말 23:30까지) || CLOSED: 연중무휴 || WEB: https://english.visitseoul.net/attractions/Namsan-Seoul-Tower/ENP00036',
    price_krw: 21000,
  ...
  // 4. 창덕궁과 후원
  {
    ...
    desc_en: 'UNESCO World Heritage palace renowned for its masterfully integrated nature, Injeongjeon throne hall, and scenic Secret Garden. || SUBWAY: 3호선 안국역 3번 출구 (도보 5분) / 1·3·5호선 종로3가역 6번 출구 || HOURS: 09:00 ~ 18:00 (후원 사전예약 필수) || CLOSED: 매주 월요일 휴관 || WEB: https://korean.visitseoul.net/attractions/창덕궁/KOP000295',
    price_krw: 8000,
    image_url: '/assets/changdeokgung-hall.jpg',
    deep_link_template: 'https://www.klook.com/city/14-seoul-things-to-do/?spm=HypeHeritage',
  },
  // 5. 덕수궁 & 돌담길
  {
  ...
  // 6. 동대문디자인플라자 (DDP)
  {
    ...
    desc_en: 'World-famous futuristic landmark designed by Zaha Hadid, hosting global fashion weeks and spectacular Seoul Light media art festivals. || SUBWAY: 2·4·5호선 동대문역사문화공원역 1번 출구 연결 || HOURS: 10:00 ~ 20:00 (야외공간 24시간 개방) || CLOSED: 연중무휴 || WEB: https://english.visitseoul.net/attractions/Dongdaemun-Design-Plaza-en/ENP024679',
    price_krw: 0,
    image_url: 'https://tong.visitkorea.or.kr/cms/resource/60/4105560_image2_1.jpg',
    deep_link_template: 'https://www.klook.com/city/14-seoul-things-to-do/?spm=HypeHeritage',
  },
  // 7. 북촌한옥마을
  {
  ...
  // 9. 홍대 걷고싶은거리
  {
    ...
    price_krw: 0,
    image_url: '/assets/hongdae-street.jpg',
    deep_link_template: 'https://www.klook.com/city/14-seoul-things-to-do/?spm=HypeHeritage',
  },
  // 10. 광장시장
  {
  ...
  // 21. 창경궁 & 대온실 [신규]
  {
    ...
    price_krw: 1000,
    image_url: 'https://tong.visitkorea.or.kr/cms/resource/96/3384896_image2_1.JPG',
    deep_link_template: 'https://www.klook.com/city/14-seoul-things-to-do/?spm=HypeHeritage',
  },
  // 22. 종묘 [신규]
  {
    ...
    price_krw: 1000,
    image_url: '/assets/jongmyo-main.jpg',
    deep_link_template: 'https://www.klook.com/city/14-seoul-things-to-do/?spm=HypeHeritage',
  },
  // 23. 남산골한옥마을 [신규]
  {
    ...
    price_krw: 0,
    image_url: '/assets/namsangol-hanok.jpg',
    deep_link_template: 'https://www.klook.com/city/14-seoul-things-to-do/?spm=HypeHeritage',
  },
  // 24. 인사동 쌈지길 & 안녕인사동 [신규]
  {
    ...
    price_krw: 0,
    image_url: '/assets/insadong-ssamzigil.jpg',
    deep_link_template: 'https://www.klook.com/city/14-seoul-things-to-do/?spm=HypeHeritage',
  },
  // 25. 63스퀘어 & 63전망대 [신규]
  {
  ...
  // 30. 광화문광장 & 세종대왕 동상 [신규]
  {
    ...
    desc_en: 'The historic heart of Seoul featuring iconic statues of King Sejong the Great and Admiral Yi Sun-sin against Bukhansan Mountain. || SUBWAY: 5호선 광화문역 2, 7번 출구 광장 직결 || HOURS: 24시간 상시 개방 || CLOSED: 연중무휴 || WEB: https://english.visitseoul.net/attractions/Gwanghwamun-Square/ENP001899',
    price_krw: 0,
    image_url: '/assets/gwanghwamun-square.jpg',
    deep_link_template: 'https://www.klook.com/city/14-seoul-things-to-do/?spm=HypeHeritage',
  },
];

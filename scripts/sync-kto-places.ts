...
export const VERIFIED_SEOUL_LANDMARKS: CatalogItemPayload[] = [
  // 1. 경복궁 & 광화문
  {
    ...
    title_en: 'Gyeongbokgung Palace & Gwanghwamun (경복궁 & 광화문)',
    desc_en: 'The main royal palace of the Joseon dynasty built in 1395, famous for the majestic Gwanghwamun royal guard changing ceremony. || SUBWAY: 3호선 경복궁역 5번 출구 (도보 3분) / 5호선 광화문역 2번 출구 || HOURS: 09:00 ~ 18:00 (입장마감 17:00, 계절별 상이) || CLOSED: 매주 화요일 휴관 || WEB: https://korean.visitseoul.net/attractions/경복궁/KOP000072',
    price_krw: 3000,
    image_url: 'https://tong.visitkorea.or.kr/cms/resource/72/3069472_image2_1.JPG',

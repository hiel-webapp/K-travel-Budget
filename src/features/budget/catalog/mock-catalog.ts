...
export const LOCAL_TRANSIT_OPTIONS: LocalTransitOptionDef[] = [
  {
    ...
    descriptionEn: "Explore cities efficiently using public transit (subways and city buses).",
  ...
  },
  {
    style: "STANDARD_MIX",
    nameKo: "대중교통 + 택시",
    nameEn: "Public Transit + Taxi",
    pricePerDayKrw: 9500,
    subwayTripsPerDay: 3,
    taxiTripsPerDay: 1,
    descriptionKo: "기본 이동은 대중교통(지하철/버스)을 이용하고, 짐이 있거나 피로할 때 단거리 택시를 1회 탑승합니다.",
    descriptionEn: "Use public transit for main travel, take a short taxi ride when tired or carrying bags.",
  ...
  },
  {
    ...
    subwayTripsPerDay: 1,
    taxiTripsPerDay: 2,
    descriptionKo: "카카오T와 일반 택시를 주로 이용하여 환승 없이 편안하게 문 앞까지 이동합니다.",
    descriptionEn: "Door-to-door comfort using Kakao T and local taxis.",
...
export const MOCK_PRICE_CATALOG: BudgetBasketDefinition[] = [
  // === Accommodation (10 Supported Cities x 4 Archetypes + Legacy Support) ===
  // --- SEOUL ---
  {
  ...
  // --- YEOSU ---
  {
    ...
    scope: "CITY",
    supportedBudgetTier: "BUDGET",
    applicableCity: "YEOSU",
    representativePriceKrw: 36000,
    priceMinKrw: 27000,
    priceMaxKrw: 48600,
    pricingUnit: "ROOM_NIGHT",
    calculationStrategy: "ROOM_NIGHT",
